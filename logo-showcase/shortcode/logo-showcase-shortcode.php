...
function logo_showcase_wordpress_shortcode_register( $atts, $content = null ) {
	...
	$logo_showcase_columns_radius              = get_post_meta( $postid, 'logo_showcase_columns_radius', true );
	$grid_column_pleft                         = get_post_meta( $postid, 'grid_column_pleft', true );
	$grid_column_pbottom                       = get_post_meta( $postid, 'grid_column_pbottom', true );
	...
	$columndesktop                             = get_post_meta( $postid, 'columndesktop', true );
	$columndesktopsmall                        = get_post_meta( $postid, 'columndesktopsmall', true );
	$columnmobile                              = get_post_meta( $postid, 'columnmobile', true );
	$grid_normal_lists                         = get_post_meta( $postid, 'grid_normal_lists', true );
	$list_normal_column                        = get_post_meta( $postid, 'list_normal_column', true );
	$list_columndesktop                        = get_post_meta( $postid, 'list_columndesktop', true );
	$list_columndesktopsmall                   = get_post_meta( $postid, 'list_columndesktopsmall', true );
	$list_columnmobile                         = get_post_meta( $postid, 'list_columnmobile', true );
	...
	$slide_center_mode                         = get_post_meta( $postid, 'slide_center_mode', true );
	$logo_showcase_free_direction        	   = get_post_meta( $postid, 'logo_showcase_free_direction', true );
	...
	$logo_showcase_free_open_link              = get_post_meta( $postid, 'logo_showcase_free_open_link', true );
	$logo_showcase_table_header_bg      	   = get_post_meta( $postid, 'logo_showcase_table_header_bg', true );
	$logo_showcase_table_header_text      	   = get_post_meta( $postid, 'logo_showcase_table_header_text', true );
	$logo_showcase_header_font_size      	   = get_post_meta( $postid, 'logo_showcase_header_font_size', true );
